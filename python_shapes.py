...
# def shape(number_of_sides, side_length, color):
# 	for i in range(number_of_sides):
# 		angle=360/int(number_of_sides)
# 		pendown()
# 		pencolor(color)
# 		forward(side_length)
# 		right(angle)    # ---tri moving in a spiral...work on it 																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																									````````````````
